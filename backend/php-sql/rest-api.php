...
/**
 * @author Mad Agency <roman.mindolin@gmail.com>
 * @copyright Mad Agency 2019
 * @package krylatskoe_abc_school
 * 
 * 
...
$config["dbase"] 		= "db_krylatskoe_abc_school" ; 		//Database
...
$config["abs_url_images"] 		= "http://domain.com/apps/krylatskoe_abc_school//media/image/" ; 		//Absolute Images URL
$config["abs_url_videos"] 		= "http://domain.com/apps/krylatskoe_abc_school//media/media/" ; 		//Absolute Videos URL
$config["abs_url_audios"] 		= "http://domain.com/apps/krylatskoe_abc_school//media/media/" ; 		//Absolute Audio URL
$config["abs_url_files"] 		= "http://domain.com/apps/krylatskoe_abc_school//media/file/" ; 		//Absolute Files URL
...
switch($_GET["json"]){	// TODO: -+- route
	case "route":		$rest_api=array();
		$rest_api["site"]["name"] = "Krylatskoe ABC School" ;
		$rest_api["site"]["description"] = "Krylatskoe ABC School" ;
