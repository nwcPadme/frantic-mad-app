...
.config(function($stateProvider, $urlRouterProvider,$sceDelegateProvider,$httpProvider,$ionicConfigProvider){
	...
	.state("krylatskoe_abc_school.admob", {
		url: "/admob",
		cache:false,
		views: {
			"krylatskoe_abc_school-side_menus" : {
						templateUrl:"templates/krylatskoe_abc_school-admob.html",
	...
	.state("krylatskoe_abc_school.admob_", {
		url: "/admob_",
		views: {
			"krylatskoe_abc_school-side_menus" : {
						templateUrl:"templates/krylatskoe_abc_school-admob_.html",
						controller: "admob_Ctrl"
					},
			"fabButtonUp" : {
						template: '',
					},
	...
	.state("krylatskoe_abc_school.facebook_login", {
		url: "/facebook_login",
		cache:false,
		views: {
			"krylatskoe_abc_school-side_menus" : {
						templateUrl:"templates/krylatskoe_abc_school-facebook_login.html",
						controller: "facebook_loginCtrl"
					},
			"fabButtonUp" : {
						template: '',
					},
